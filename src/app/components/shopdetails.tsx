...
const Shopdetails = () => {
  ...
  <div>
    ...
    <div className="relative font-[sans-serif] before:absolute before:w-full before:h-full before:inset-0 before:bg-black before:opacity-50 before:z-10">
      ...
      />
      <div className="min-h-[350px] relative z-50 max-w-4xl mx-auto flex flex-col justify-center items-center text-center p-6">
        <h2 className="text-white md:text-5xl text-3xl font-bold mb-8">Shop Details</h2>
        <div className="flex items-center space-x-2 text-black">
          <a href="/" className="text-white">
            Home{" "}
          </a>
  ...
  <div>
    <div className="flex flex-col md:flex-row ">
      ...
      <div className="m-4 md:m-20">
        {/* In Stock */}
        <div className="flex flex-col md:flex-row gap-4 md:gap-60">
          <div className="h-8 w-28 bg-orange-700 text-white pt-1 pl-2">In Stock</div>
          <div>
            <Image
              src={"/Group 1000002153.png"}
              height={100}
        ...
        <div>
          <h2 className="font-extrabold text-3xl mt-5">Yummy Chicken Chup</h2>
          <p className="w-full md:w-96 mt-5 text-gray-700">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni
            excepturi illo eveniet nihil iure, earum harum necessity
          </p>
          <hr className="mt-5" />
          ...
          <div className="flex mt-2">
            ...
            <RiStarSFill className="text-yellow-600 ml-1" />
            <RiStarSFill className="text-yellow-600 ml-1" />
            <p className="ml-7 text-gray-700">| 5.0 Ratings</p>
            <p className="ml-7 text-gray-700">| 22 Reviews</p>
          </div>
          <p className="mt-2 text-gray-700">Dictum/cursus/Risus</p>
          ...
          <div className="flex flex-col md:flex-row gap-4 mt-4">
            <div className="h-8 w-10 border-gray-700 border-2 border-solid text-gray-600 text-xl px-2">-</div>
            <div className="h-8 w-10 border-gray-700 border-2 border-solid text-gray-600 text-xl px-2 font-bold">1</div>
            <div className="h-8 w-10 border-gray-700 border-2 border-solid text-gray-600 text-xl px-2">+</div>
            <div className="h-10 w-40 border-orange-700 border-2 border-solid bg-orange-700 text-white flex items-center justify-center mt-4 md:ml-10">
              <FaShoppingCart size={30} />
              <span className="pt-2">Add To Cart</span>
            </div>
          </div>
        ...
        <div>
          ...
          <div className="flex flex-col md:flex-row mt-3">
            <h2 className="text-gray-700">Share:</h2>
    ...
    {/* Bottom Area */}
    <div className="ml-4 md:ml-40 mr-4 md:mr-20">
      {/* Description */}
      <div className="flex flex-col md:flex-row">
        <div className="h-10 w-36 bg-orange-700 text-white font-semibold pt-2 pl-2">
          Description
      ...
      <div>
        <p className="text-gray-700 mt-7">
          ...
          quaerat facilis, explicabo architecto?
          Laborum eum quo ut fugit voluptatem, nisi ipsam numquam aliquam sit
          eos totam animi officiis eius explicabo nostrum cumque a tempore
          inventore. Accusamus possimus modi, velit rerum aliquam repellat
          voluptatum.
        </p>
        <p className="mt-7 text-gray-700 ">
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolore cumque
          in blanditiis. Sequi ipsam exercitationem quia inventore incidunt
          possimus voluptatum asperiores! Corrupti accusantium enim, similique
          totam aperiam explicabo quaerat nemo!
        </p>

        <h2 className="text-xl font-medium mt-3">Key Benefits</h2>
        <ul className="text-gray-700 mt-3">
