...
const Signin = () => {
  ...
  return (
    ...
    <div className='h-auto bg-white p-6 max-w-lg mx-auto shadow-lg rounded-lg'>
       ...
       <h2 className='text-black mt-4 ml-5 mb-4'>Dont Have An Account? <span onClick={()=>(router.push("/signup"))} className='text-orange-700 ml-2 underline cursor-pointer'>SignUp</span></h2>
