                ...
                <div className="space-y-6 bg-white">
                    ...
                    <div className="flex justify-between pt-4 flex-wrap gap-4">
                        <Button
                            ...
                            className="py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium bg-slate-200 text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 w-full sm:w-72 h-12 px-3"
                        >
                            Back to cart
                        </Button>
